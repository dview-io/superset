...
const Dsense = () => {
  ...
  useEffect(() => {
    if (!credentials.emailid || !credentials.password || !dsenseUrl) {
      return;
    }
    ...
    const handleIframeLoad = () => {
      try {
        ...
        setTimeout(() => {
          ...
          // Scroll to bottom after iframe loads and message is sent
          setTimeout(() => {
            scrollToBottom();
          }, 1000);
        }, 500);
  ...
  }, [dsenseUrl, credentials.emailid, credentials.password]);

  // Handle case where dsenseUrl is not available
  if (!dsenseUrl) {
    return (
      <div
        style={{
