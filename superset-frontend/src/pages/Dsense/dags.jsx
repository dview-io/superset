...
const Dags = () => {
  const dags_url = window.featureFlags.DAGS_URL;
  ...
  const handleIframeLoad = () => {
    try {
      const targetOrigin = new URL(dags_url).origin;
  ...
  if (!dags_url) {
    ...
    return (
      <div style={centeredStyle}>
        ...
        <p>Dags URL is not configured. Redirecting...</p>
      </div>
    );
  }
    ...
    <div style={{ maxHeight: '100vh' }}>
      <iframe
        ...
        onError={() => {
          ...
          setError(new Error('Failed to load Dags application'));
          setTimeout(() => {
            window.location.href = ERROR_REDIRECT_URL;
          }, 2000);
        }}
