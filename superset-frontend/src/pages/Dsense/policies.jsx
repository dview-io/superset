...
const Policies = () => {
  const policiesUrl = window.featureFlags.POLICIES_URL;
  ...
  const handleIframeLoad = () => {
    try {
      const targetOrigin = new URL(policiesUrl).origin;
  ...
  if (!policiesUrl) {
    ...
    return (
      <div style={centeredStyle}>
        ...
        <p>Policies URL is not configured. Redirecting...</p>
      </div>
    );
  }
