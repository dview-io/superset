...
const JobWeaver = () => {
  const jobweaver_url = window.featureFlags.JOBWEAVER_URL;
  ...
  const handleIframeLoad = () => {
    try {
      const targetOrigin = new URL(jobweaver_url).origin;
  ...
  if (!jobweaver_url) {
    ...
    return (
      <div style={centeredStyle}>
        ...
        <p>JobWeaver URL is not configured. Redirecting...</p>
      </div>
    );
  }
    ...
    <div style={{ maxHeight: '100vh' }}>
      <iframe
        ...
        onError={() => {
          ...
          setError(new Error('Failed to load JobWeaver application'));
          setTimeout(() => {
            window.location.href = ERROR_REDIRECT_URL;
          }, 2000);
        }}
