...
CORS_OPTIONS = {
  ...
  'allow_headers': ['*'],
  'resources':['*'],
  'origins': ['http://localhost:8088', 'https://analytics-dview.internal.bijnis.com', 'https://cortex.dview.io']
}
...
TALISMAN_ENABLED = utils.cast_to_boolean(False)
